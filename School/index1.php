        ...
        <div class="d-flex flex-column" id="content-wrapper">
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group"><input class="bg-light form-control border-0 small" type="text" placeholder="Search for ..." style="width: 200px;"><button class="btn btn-primary py-0" type="button"><i class="fas fa-search"></i></button></div>
                        </form>
                        <nav class="navbar navbar-light navbar-expand-md py-3">
                            <div class="container"><a class="navbar-brand active" href="index1.php"><span>Dashboard</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                                <div class="collapse navbar-collapse" id="navcol-2">
                                    <ul class="navbar-nav ms-auto">
                                        <li class="nav-item"><a class="nav-link" href="Lern.php" target="_top">E-Learning</a></li>
                                        ...
                                        <?php
                                         if (isset($_SESSION['username'])){
                                           echo '<ul style="position: relative; left: 250px;"; class="navbar-nav ms-auto><li class="nav-item"><a class="nav-link";<i class="fa-solid fa-user"></i><b>'.$_SESSION["username"].'</b></a></li><ul></ul><li class="nav-item"><b><a class="nav-link"; href="index.php" style="background-color:red;"><i class="fa-solid fa-right-to-bracket" style="background-color:red;"></i> Logout</a></b></li></ul>';
                                        }else{
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="profile.html"><span class="d-none d-lg-inline me-2 text-gray-600 small">Kenzie</span><img class="border rounded-circle img-profile" src="#"></a>
                            ...
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Project</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>21</span></div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>total test</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span>51</span></div>
                                        </div>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © Impaction2023</span></div>
                </div>
            </footer>
